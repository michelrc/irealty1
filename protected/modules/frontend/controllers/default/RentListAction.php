 ...
 * Time: 14:35
 */
class RentListAction extends CAction
{
    public function run()
    {
        ...
        $page_general_info = RentListPageGeneralInfo::model()->find();
        ...
        $price_range = RentListPageFilterConfig::model()->findAll($filter_criteria);
        ...
        $criteria->compare('property_category.slug', 'rent');
        ...
        {
            $price_range_selected = RentListPageFilterConfig::model()->findByPk($price_range_id);
