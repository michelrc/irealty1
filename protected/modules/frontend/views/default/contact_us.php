<div class="page-banner">
    ...
    <img src="<?php echo $banner_image_mobile ?>" src="<?php echo $banner_image_alt ?>"
         class="image-responsive visible-xs-block">
</div>
                            ...
                            <?php foreach ($contact_reason as $key => $reason): ?>
                                <?php if (isset($_GET['q'])): ?>
                                    <option value="<?php echo $reason['id'] ?>"
                                            <?php if ($reason['selected']): ?>selected<?php endif ?> ><?php echo $reason['title'] ?></option>
                                <?php else: ?>
                                    <option value="<?php echo $reason['id'] ?>"
                                            <?php if ($key == 0): ?>selected<?php endif ?> ><?php echo $reason['title'] ?></option>
                                <?php endif ?>
                            <?php endforeach ?>
                        </select>
                    </div>
                    <div class="form-group form-group-lg">
                        <input type="text" name="name" placeholder="<?php echo $place_holder_name ?>" required
                               class="form-control input-lg">
                    </div>
                    <div class="form-group form-group-lg">
                        <input id="contact_phone" type="tel" name="phone" placeholder="<?php echo $place_holder_phone ?>"
                               class="form-control input-lg">
                    </div>
                    <div class="form-group form-group-lg">
                        <input type="email" pattern="[\w-\.]{1,}@([\w-]{2,}\.)*([\w-]{2,}\.)[\w-]{2,4}" name="email"
                               placeholder="<?php echo $place_holder_email ?>" required class="form-control input-lg">
                    </div>
                    <div class="form-group form-group-lg">
                    ...
                    <div class="form-group text-center">
                        <button type="submit" role="button" class="rounded-btn big-rounded hover-transition">
                            ...
                            <?php if (Yii::app()->getLanguage() == 'es'): ?>
                                <?php echo Yii::t('Property', '<strong>Enviar</strong>') ?>
                            <?php endif ?>
                        </button>
                    </div>
                </form>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 contact-info">
                ...
                <div class="brokers">
                    <?php foreach ($agents as $agent): ?>
                        <div class="profile text-center">
                            <img src="<?php echo $agent['photo'] ?>" alt="<?php echo $agent['photo_alt'] ?>"
                                 class="img-thumbnail img-circle image-responsive">
                ...
                <ul class="list-inline pull-left contact-socials">
                    <?php if (isset($this->common_data['facebook_link'])): ?>
                        <li><a href="<?php echo $this->common_data['facebook_link'] ?>"><i
                                    class="fa fa-facebook"></i></a>
                        </li>
                    <?php endif;
                    if (isset($this->common_data['google_plus_link'])):?>
                        <li><a href="<?php echo $this->common_data['google_plus_link'] ?>"><i
                ...
                <?php foreach ($most_popular_properties as $popular_property): ?>
                    ...
                    <div class="property-item">
                        <?php if (isset($popular_property['image'])): ?>
                            <img src="<?php echo $popular_property['image'] ?>"
                                 alt="<?php echo $popular_property['image_alt'] ?>" class="image-responsive">
                        <?php else: ?>
                        ...
                        <div class="detail-info">
                            <a href="" role="button" class="pull-right detail-trigger">
                                ...
                                class="price">USD<strong>$<?php echo $popular_property['price'] ?></strong></span>

                            <div class="details">
                                <ul class="list-unstyled">
                                    <li><i class="fa fa-map-marker"></i><span
                                            class="detail-title"><?php echo Yii::t('Property', 'Place') ?></span>

                                        <p><?php echo $popular_property['address'] ?></p>
                                    </li>
                                    <li><i class="fa fa-arrows"></i><span
                                            class="detail-title"><?php echo Yii::t('Property', 'Area') ?></span><span><?php echo $popular_property['area'] ?>
                                            m<sup>2</sup></span>
                                    </li>
                                ...
                                <a href="<?php echo $this->createUrl('/frontend/default/property', array('id' => $popular_property['id'])) ?>"
