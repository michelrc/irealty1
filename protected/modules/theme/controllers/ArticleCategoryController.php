...
class ArticleCategoryController extends GxController {
...
//				'users'=>mod('user')->getAdmins(),
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'ArticleCategory');
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation($model, 'article-category-form');
		...
		if (isset($_POST['ArticleCategory'])) {
			$model->setAttributes($_POST['ArticleCategory']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"ArticleCategory")->delete()){
	...
	public function actionAdmin() {
		...
		if (isset($_GET['ArticleCategory']))
			$model->setAttributes($_GET['ArticleCategory']);
