...
class PropertyCategoryController extends GxController {
...
public function accessRules() {
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'PropertyCategory');
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation($model, 'property-category-form');
...
$this->redirect(array('admin'));
		...
		if (isset($_POST['PropertyCategory'])) {
			$model->setAttributes($_POST['PropertyCategory']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"PropertyCategory")->delete()){
	...
	public function actionAdmin() {
		...
		if (isset($_GET['PropertyCategory']))
			$model->setAttributes($_GET['PropertyCategory']);
