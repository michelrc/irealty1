...
class BuyListPageFilterConfigController extends GxController {
...
//				'users'=>mod('user')->getAdmins(),
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'BuyListPageFilterConfig');
	...
	public function actionCreate() {
		...
		$model = new BuyListPageFilterConfig;


		$this->performAjaxValidation($model, 'buy-list-page-filter-config-form');
		...
		if (isset($_POST['BuyListPageFilterConfig'])) {
			$model->setAttributes($_POST['BuyListPageFilterConfig']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"BuyListPageFilterConfig")->delete()){
	...
	public function actionAdmin() {
		$model = new BuyListPageFilterConfig('search');
		//$model->unsetAttributes();

		if (isset($_GET['BuyListPageFilterConfig']))
			$model->setAttributes($_GET['BuyListPageFilterConfig']);
