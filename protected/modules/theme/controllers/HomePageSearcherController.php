...
class HomePageSearcherController extends GxController {
...
public function accessRules() {
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'HomePageSearcher');
	...
	public function actionCreate() {
		$model = new HomePageSearcher;


		$this->performAjaxValidation($model, 'home-page-searcher-form');
		...
		if (isset($_POST['HomePageSearcher'])) {
			$model->setAttributes($_POST['HomePageSearcher']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"HomePageSearcher")->delete()){
	...
	public function actionAdmin() {
		$model = new HomePageSearcher('search');
		...
		if (isset($_GET['HomePageSearcher']))
			$model->setAttributes($_GET['HomePageSearcher']);
