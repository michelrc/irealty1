...
class HomePageContactUsController extends GxController {
...
public function accessRules() {
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'HomePageContactUs');
	...
	public function actionCreate() {
		$model = new HomePageContactUs;


		$this->performAjaxValidation($model, 'home-page-contact-us-form');
...
$this->redirect(array('admin'));
		...
		if (isset($_POST['HomePageContactUs'])) {
			$model->setAttributes($_POST['HomePageContactUs']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"HomePageContactUs")->delete()){
	...
	public function actionAdmin() {
		$model = new HomePageContactUs('search');
		//$model->unsetAttributes();

		if (isset($_GET['HomePageContactUs']))
			$model->setAttributes($_GET['HomePageContactUs']);
