...
class NavigationMenuController extends GxController {
...
//				'users'=>mod('user')->getAdmins(),
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'NavigationMenu');
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation($model, 'navigation-menu-form');
		...
		if (isset($_POST['NavigationMenu'])) {
			$model->setAttributes($_POST['NavigationMenu']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"NavigationMenu")->delete()){
	...
	public function actionAdmin() {
		$model = new NavigationMenu('search');
		...
		if (isset($_GET['NavigationMenu']))
			$model->setAttributes($_GET['NavigationMenu']);
