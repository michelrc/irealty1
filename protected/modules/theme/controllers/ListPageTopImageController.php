...
class ListPageTopImageController extends GxController {
...
//				'users'=>mod('user')->getAdmins(),
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'ListPageTopImage');
	...
	public function actionCreate() {
		$model = new ListPageTopImage;


		$this->performAjaxValidation($model, 'list-page-top-image-form');
		...
		if (isset($_POST['ListPageTopImage'])) {
			$model->setAttributes($_POST['ListPageTopImage']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"ListPageTopImage")->delete()){
	...
	public function actionAdmin() {
		$model = new ListPageTopImage('search');
		//$model->unsetAttributes();

		if (isset($_GET['ListPageTopImage']))
			$model->setAttributes($_GET['ListPageTopImage']);
