...
class AboutUsPageController extends GxController {
...
//				'users'=>mod('user')->getAdmins(),
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'AboutUsPage');
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation($model, 'about-us-page-form');
		...
		if (isset($_POST['AboutUsPage'])) {
			$model->setAttributes($_POST['AboutUsPage']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"AboutUsPage")->delete()){
	...
	public function actionAdmin() {
		...
		if (isset($_GET['AboutUsPage']))
			$model->setAttributes($_GET['AboutUsPage']);
