...
class BuyListPageGeneralInfoController extends GxController {
...
//				'users'=>mod('user')->getAdmins(),
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'BuyListPageGeneralInfo');
	...
	public function actionCreate() {
		$model = new BuyListPageGeneralInfo;
        $model_filters = new BuyListPageFilterConfig('search');
        $model_top_images = new BuyListPageTopImage('search');


		$this->performAjaxValidation($model, 'buy-list-page-general-info-form');
		...
		if (isset($_POST['BuyListPageGeneralInfo'])) {
			$model->setAttributes($_POST['BuyListPageGeneralInfo']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"BuyListPageGeneralInfo")->delete()){
	...
	public function actionAdmin() {
		$model = new BuyListPageGeneralInfo('search');
		...
		if (isset($_GET['BuyListPageGeneralInfo']))
			$model->setAttributes($_GET['BuyListPageGeneralInfo']);
