...
class CompanyInfoController extends GxController {
...
//				'users'=>mod('user')->getAdmins(),
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'CompanyInfo');
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation($model, 'company-info-form');
		...
		if (isset($_POST['CompanyInfo'])) {
			$model->setAttributes($_POST['CompanyInfo']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"CompanyInfo")->delete()){
	...
	public function actionAdmin() {
		...
		if (isset($_GET['CompanyInfo']))
			$model->setAttributes($_GET['CompanyInfo']);
