...
class PropertyAmenitieController extends GxController {
...
public function accessRules() {
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'PropertyAmenitie');
	...
	public function actionCreate() {
		$model = new PropertyAmenitie;


		$this->performAjaxValidation($model, 'property-amenitie-form');




		if (isset($_POST['PropertyAmenitie'])) {
			$model->setAttributes($_POST['PropertyAmenitie']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"PropertyAmenitie")->delete()){
	...
	public function actionAdmin() {
		$model = new PropertyAmenitie('search');
		//$model->unsetAttributes();

		if (isset($_GET['PropertyAmenitie']))
			$model->setAttributes($_GET['PropertyAmenitie']);
