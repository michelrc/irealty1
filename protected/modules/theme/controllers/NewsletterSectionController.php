...
class NewsletterSectionController extends GxController {
...
//				'users'=>mod('user')->getAdmins(),
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'NewsletterSection');
	...
	public function actionCreate() {
		$model = new NewsletterSection;


		$this->performAjaxValidation($model, 'newsletter-section-form');
		...
		if (isset($_POST['NewsletterSection'])) {
			$model->setAttributes($_POST['NewsletterSection']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"NewsletterSection")->delete()){
	...
	public function actionAdmin() {
		$model = new NewsletterSection('search');
		...
		if (isset($_GET['NewsletterSection']))
			$model->setAttributes($_GET['NewsletterSection']);
