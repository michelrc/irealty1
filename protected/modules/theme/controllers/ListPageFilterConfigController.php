...
class ListPageFilterConfigController extends GxController {
...
public function accessRules() {
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'ListPageFilterConfig');
	...
	public function actionCreate() {
		$model = new ListPageFilterConfig;


		$this->performAjaxValidation($model, 'list-page-filter-config-form');
		...
		if (isset($_POST['ListPageFilterConfig'])) {
			$model->setAttributes($_POST['ListPageFilterConfig']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"ListPageFilterConfig")->delete()){
	...
	public function actionAdmin() {
		$model = new ListPageFilterConfig('search');
		//$model->unsetAttributes();

		if (isset($_GET['ListPageFilterConfig']))
			$model->setAttributes($_GET['ListPageFilterConfig']);
