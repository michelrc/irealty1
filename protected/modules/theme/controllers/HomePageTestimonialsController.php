...
class HomePageTestimonialsController extends GxController {
...
public function accessRules() {
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'HomePageTestimonials');
	...
	public function actionCreate() {
		$model = new HomePageTestimonials;


		$this->performAjaxValidation($model, 'home-page-testimonials-form');
...
$this->redirect(array('admin'));
		...
		if (isset($_POST['HomePageTestimonials'])) {
			$model->setAttributes($_POST['HomePageTestimonials']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"HomePageTestimonials")->delete()){
	...
	public function actionAdmin() {
		$model = new HomePageTestimonials('search');
		//$model->unsetAttributes();

		if (isset($_GET['HomePageTestimonials']))
			$model->setAttributes($_GET['HomePageTestimonials']);
