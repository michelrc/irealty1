...
class SocialNetworksController extends GxController {
...
public function accessRules() {
	...
	public function actionView($id) {
        $model = $this->loadModel($id, 'SocialNetworks');
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation($model, 'social-networks-form');
		...
		if (isset($_POST['SocialNetworks'])) {
			$model->setAttributes($_POST['SocialNetworks']);
...
{
    if(isset($id)){
         if($this->loadModel($id,"SocialNetworks")->delete()){
	...
	public function actionAdmin() {
		...
		if (isset($_GET['SocialNetworks']))
			$model->setAttributes($_GET['SocialNetworks']);
