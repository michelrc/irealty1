...
<?php $this->widget('application.extensions.bootstrap.widgets.TbEditableDetailView', array(
	...
	'attributes' => array(
                    ...
                    array(
                            'label' => t('Map image PC'),
                            'type' => 'raw',
                            'value' => CHtml::image($model->_banner_image->getFileUrl('normal'), '', array('width'=> '100px')),
                        )
                ,
                    array(
                            'label' => t('Map image Mobile'),
                            'type' => 'raw',
                            'value' => CHtml::image($model->_banner_image_mobile->getFileUrl('normal'), '', array('width'=> '100px')),
                        )
                ,
array(
