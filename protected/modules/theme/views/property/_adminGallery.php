...
<?php if(user()->isAdmin):?>
    ...
    <?php echo CHtml::link(TbHtml::icon('glyphicon glyphicon-plus'). t('Add item'),array('/theme/PropertyGallery/create?blank=1'),array('class'=>'btn btn-default various', 'data-fancybox-type' => 'iframe'));?>
<?php endif?>
</div>
