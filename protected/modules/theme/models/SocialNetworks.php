...
Yii::import('theme.models._base.BaseSocialNetworks');

class SocialNetworks extends BaseSocialNetworks
{
    /**
    ...
    */
    public $adminNames=array('SocialNetworks','socialnetworks','socialnetworks','General config'); // admin interface, singular, plural
    ...
    */
    public function attributeWidgets()
    {
        return array(
                array('id', 'textField'),
                    array('facebook_link', 'textField'),
                    array('twitter_link', 'textField'),
                    array('google_plus_link', 'textField'),
                    array('instagram_link', 'textField'),
            );
    }
