...
Yii::import('theme.models._base.BaseNewsletter');
...
class Newsletter extends BaseNewsletter
{
    ...
    */
    ...
    public function init(){
        $this->id = rand_uniqid();
        $this->adminNames[3] = Yii::t('sideMenu', 'Newsletter');
    }
    ...
    */
    public $adminNames=array('Newsletters','newsletter','newsletters','Newsletter'); // admin interface, singular, plural
    ...
    */
    public function attributeWidgets()
    {
        return array(
                array('id', 'textField'),
                    array('subscriber', 'textField'),
                    array('created', 'textField'),
            );
    }
