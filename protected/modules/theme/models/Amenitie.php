...
Yii::import('theme.models._base.BaseAmenitie');

class Amenitie extends BaseAmenitie
{
    /**
    ...
    */
    public $adminNames=array('Amenities','amenitie','amenities','Properties'); // admin interface, singular, plural
