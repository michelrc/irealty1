...
Yii::import('theme.models._base.BaseHomePageTestimonials');

class HomePageTestimonials extends BaseHomePageTestimonials
{
    /**
    ...
    */
    public $adminNames=array('HomePageTestimonials','homepagetestimonials','homepagetestimonials','Home page'); // admin interface, singular, plural
