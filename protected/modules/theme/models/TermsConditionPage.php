...
Yii::import('theme.models._base.BaseTermsConditionPage');

class TermsConditionPage extends BaseTermsConditionPage
{
    /**
    ...
    */
    ...
    public function init(){
        $this->id = rand_uniqid();
        $this->adminNames[3] = Yii::t('sideMenu', 'Terms & Condition page');
    }
    ...
    */
    public $adminNames=array('TermsConditionPages','termsconditionpage','termsconditionpages','Terms & Condition page'); // admin interface, singular, plural
