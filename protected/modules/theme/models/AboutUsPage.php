...
Yii::import('theme.models._base.BaseAboutUsPage');
...
class AboutUsPage extends BaseAboutUsPage
{
    ...
    */
    ...
    public function init(){
        $this->id = rand_uniqid();
        $this->adminNames[3] = Yii::t('sideMenu', 'About Us page');
    }
    ...
    */
    public $adminNames=array('AboutUsPages','aboutuspage','aboutuspages','About Us page'); // admin interface, singular, plural
