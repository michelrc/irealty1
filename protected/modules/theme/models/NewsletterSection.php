...
Yii::import('theme.models._base.BaseNewsletterSection');

class NewsletterSection extends BaseNewsletterSection
{
    /**
    ...
    */
    public $adminNames=array('NewsletterSections','newslettersection','newslettersections','General config'); // admin interface, singular, plural
