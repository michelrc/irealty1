...
Yii::import('theme.models._base.BasePropertyType');
...
class PropertyType extends BasePropertyType
{
    ...
    */
    public $adminNames=array('PropertyTypes','propertytype','propertytypes','Properties'); // admin interface, singular, plural
