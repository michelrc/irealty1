...
Yii::import('theme.models._base.BaseRentListPageFilterConfig');

class RentListPageFilterConfig extends BaseRentListPageFilterConfig
{
    /**
    * @param string $className
    * @return RentListPageFilterConfig    */
    ...
    */
    public $adminNames=array('RentListPageFilterConfigs','rentlistpagefilterconfig','rentlistpagefilterconfigs','Rent properties List page'); // admin interface, singular, plural
    ...
    */
    public function attributeWidgets()
    {
        return array(
                array('id', 'textField'),
                    array('first_price', 'currency'),
                    array('last_price', 'currency'),
            );
    }
