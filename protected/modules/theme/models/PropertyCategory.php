...
Yii::import('theme.models._base.BasePropertyCategory');
...
class PropertyCategory extends BasePropertyCategory
{
    ...
    */
    public $adminNames=array('PropertyCategories','propertycategory','propertycategories','Properties'); // admin interface, singular, plural
