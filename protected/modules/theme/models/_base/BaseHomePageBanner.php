...
/**
 * This is the model base class for the table "home_page_banner".
 * It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "HomePageBanner".
 * This code was improve iReevo Team
 * Columns in table "home_page_banner" available as properties of the model,
 ...
 */
abstract class BaseHomePageBanner extends I18NInTableAdapter {
    ...
    */
    ...
    function behaviors() {
        return CMap::mergeArray(parent::behaviors(), array(
                    ...
                    'prefix' => 'img1_',
                    'relativeWebRootFolder' => '/images/HomePageBanner',
                    'formats' => array(
                    ...
                    'suffix' => '_normal',
                                        ...
                                        'process' => array('resize' => array(1263,644, 1)),
                                        ),
	...
	public static function label($n = 1) {
		return self::model()->t_model('HomePageBanner|HomePageBanners', $n);
	}
...
array('recipeImg1', 'safe'),
	...
	public function attributeLabels() {
		return array(
			'id' => $this->t_label('ID'),
			'image' => $this->t_label('Banner image Alt'),
