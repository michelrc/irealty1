...
/**
 * This is the model base class for the table "rent_list_page_top_image".
 * It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "RentListPageTopImage".
 * This code was improve iReevo Team
 * Columns in table "rent_list_page_top_image" available as properties of the model,
 ...
 */
abstract class BaseRentListPageTopImage extends I18NInTableAdapter {
    ...
    */
    ...
    function behaviors() {
        return CMap::mergeArray(parent::behaviors(), array(
                    ...
                    'prefix' => 'img1_',
                    'relativeWebRootFolder' => '/images/RentListPageTopImage',
                    'formats' => array(
	...
	public function tableName() {
		return 'rent_list_page_top_image';
	}

	public static function label($n = 1) {
		return self::model()->t_model('RentListPageTopImage|RentListPageTopImages', $n);
	}
