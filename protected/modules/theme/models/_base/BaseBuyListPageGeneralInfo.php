...
/**
 * This is the model base class for the table "buy_list_page_general_info".
 * It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "BuyListPageGeneralInfo".
 * This code was improve iReevo Team
 * Columns in table "buy_list_page_general_info" available as properties of the model,
 ...
 */
abstract class BaseBuyListPageGeneralInfo extends I18NInTableAdapter {
    ...
    */
    ...
    function behaviors() {
        return CMap::mergeArray(parent::behaviors(), array(
                    ...
                    'prefix' => 'img1_',
                    'relativeWebRootFolder' => '/images/BuyListPageGeneralInfo',
                    'formats' => array(
	...
	public function tableName() {
		return 'buy_list_page_general_info';
	}

	public static function label($n = 1) {
		return self::model()->t_model('BuyListPageGeneralInfo|BuyListPageGeneralInfos', $n);
	}
