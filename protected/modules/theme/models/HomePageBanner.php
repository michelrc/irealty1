...
Yii::import('theme.models._base.BaseHomePageBanner');

class HomePageBanner extends BaseHomePageBanner
{
    /**
    ...
    */
    public $adminNames=array('HomePageBanners','homepagebanner','homepagebanners','Home page'); // admin interface, singular, plural
