...
Yii::import('theme.models._base.BaseFooterNavigationMenu');

class FooterNavigationMenu extends BaseFooterNavigationMenu
{
    /**
    * @param string $className
    * @return FooterNavigationMenu    */
    ...
    */
    ...
    public function init(){
        $this->id = rand_uniqid();
        $this->adminNames[3] = Yii::t('sideMenu', 'Footer');
    }
    ...
    */
    public $adminNames=array('FooterNavigationMenus','footernavigationmenu','footernavigationmenus','Footer'); // admin interface, singular, plural
    ...
    public function attributeWidgets()
    {
        return array(
                array('id', 'textField'),
                    ...
                    array('about_us', 'textField'),
                    array('terms_conditions', 'textField'),
                    array('blog', 'textField'),
                    array('publish_properties', 'textField'),
            );
    }
