...
Yii::import('theme.models._base.BaseHomePageRecentsProperties');

class HomePageRecentsProperties extends BaseHomePageRecentsProperties
{
    /**
    * @param string $className
    * @return HomePageRecentsProperties    */
    ...
    */
    public $adminNames=array('HomePageRecentsProperties','homepagerecentsproperties','homepagerecentsproperties','Home page'); // admin interface, singular, plural
