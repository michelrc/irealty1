...
Yii::import('theme.models._base.BaseHomePageWhyShopIcons');

class HomePageWhyShopIcons extends BaseHomePageWhyShopIcons
{
    /**
    * @param string $className
    * @return HomePageWhyShopIcons    */
    ...
    */
    public $adminNames=array('HomePageWhyShopIcons','homepagewhyshopicons','homepagewhyshopicons','Home page'); // admin interface, singular, plural
    ...
    public function attributeWidgets()
    {
        return array(
                array('id', 'textField'),
                    ...
                    array('subtitle', 'wysiwyg'),
                    array('icon_image', 'textField'),
            );
    }
