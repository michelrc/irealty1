...
Yii::import('theme.models._base.BaseHomePageContactUs');

class HomePageContactUs extends BaseHomePageContactUs
{
    /**
    * @param string $className
    * @return HomePageContactUs    */
    ...
    */
    public $adminNames=array('HomePageContactUses','homepagecontactus','homepagecontactuses','Home page'); // admin interface, singular, plural
    ...
    public function attributeWidgets()
    {
        return array(
                array('id', 'textField'),
                    ...
                    array('image_title', 'textField'),
                    array('image_description', 'wysiwyg'),
            );
    }
