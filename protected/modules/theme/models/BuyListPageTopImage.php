...
Yii::import('theme.models._base.BaseBuyListPageTopImage');

class BuyListPageTopImage extends BaseBuyListPageTopImage
{
    /**
    * @param string $className
    * @return BuyListPageTopImage    */
    ...
    */
    ...
    public function init(){
        $this->id = rand_uniqid();
        $this->adminNames[3] = Yii::t('sideMenu', 'Propiedades en venta');
    }
    ...
    */
    public $adminNames=array('BuyListPageTopImages','buylistpagetopimage','buylistpagetopimages','Buy properties List page'); // admin interface, singular, plural
