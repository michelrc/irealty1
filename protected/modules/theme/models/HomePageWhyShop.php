...
Yii::import('theme.models._base.BaseHomePageWhyShop');

class HomePageWhyShop extends BaseHomePageWhyShop
{
    /**
    * @param string $className
    * @return HomePageWhyShop    */
    ...
    */
    public $adminNames=array('HomePageWhyShops','homepagewhyshop','homepagewhyshops','Home page'); // admin interface, singular, plural
