...
Yii::import('theme.models._base.BaseArticleCategory');
...
class ArticleCategory extends BaseArticleCategory
{
    ...
    */
    public $adminNames=array('ArticleCategories','articlecategory','articlecategories','Article'); // admin interface, singular, plural
