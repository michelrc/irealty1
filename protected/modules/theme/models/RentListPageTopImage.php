...
Yii::import('theme.models._base.BaseRentListPageTopImage');

class RentListPageTopImage extends BaseRentListPageTopImage
{
    /**
    * @param string $className
    * @return RentListPageTopImage    */
    ...
    */
    public $adminNames=array('RentListPageTopImages','rentlistpagetopimage','rentlistpagetopimages','Rent properties List page'); // admin interface, singular, plural
